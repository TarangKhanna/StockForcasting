...
// Get the data
d3.csv("IBM_merged.csv", function(error, data) {
...
// RESIZE CHART
var chart7 = $("#chart7 > #chart"),
    aspect = chart7.width() / chart7.height(),
    container = chart7.parent();
$(window).on("resize", function() {
    var targetWidth = container.width();
    chart7.attr("width", targetWidth);
    chart7.attr("height", Math.round(targetWidth / aspect));
}).trigger("resize"); 
