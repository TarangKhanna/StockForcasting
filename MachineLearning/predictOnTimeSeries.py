# ARIMA algorithm# currently it is linear regression, we need some error to measure accuracy 
...
def PredictML(stocksDf, useSVM):
	...
	print(forecast_out)
	predict_index = forecast_out
	predict_values = stocksDf[predict_index:] # apply same pre processing as X
